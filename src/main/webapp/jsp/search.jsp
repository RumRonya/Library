...
<header>
    ...
    <nav id="main">
        ...
        <ul>
            ...
            <li class="main_nav" id="here"><a href="#">Книги</a></li>
...
<article id="content">
    ...
    <article id="right_content">
        ...
        <h4 class="header_for_page"><span class="info_of_book">Поиск:</span> что ищешь </h4>
        ...
        <section id="page">
            ...
            <p class="text_page"><a href="books.php?page=1">1</a></p>
            <p class="text_page"><a href="books.php?page=">2</a></p>
            <p class="page"><a href="books.php">3</a></p>
            <p class="page" id="here_page">4</p>
            <p class="page"><a href="books.php">3</a></p>
            <p class="text_page"><a href="books.php?page=1">1</a></p>
            <p class="text_page"><a href="books.php?page=">2</a></p>
